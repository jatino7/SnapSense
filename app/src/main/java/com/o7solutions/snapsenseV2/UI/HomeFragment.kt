...
import com.o7solutions.snapsenseV2.databinding.FragmentHomeBinding
...
//            }
            ...
            audioPrompt.setOnClickListener {
                val navOptions = NavOptions.Builder()
                    .setPopUpTo(
                        navController.graph.startDestinationId,
                        false
            ...
            binding.musicSuggestion.setOnClickListener {
                val navOptions = NavOptions.Builder()
                    .setPopUpTo(
                        navController.graph.startDestinationId,
                        false
                ...
                navController.navigate(R.id.faceEmotionFragment, null, navOptions)
            }
